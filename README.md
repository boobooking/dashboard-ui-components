...
Пакет экспортирует одиннадцать компонентов: `Popup`, `Dot`, `PickDay`,
`RussianMobileFilter`, `Search`, `SelectDateInterval`, `SelectSingle`,
`SmallBadge`, `ErrorMessages`, `Closer`, `DownloadLink`. В
...
Поднимает демо-страницы со всеми одиннадцатью компонентами в двух окружениях:
