...
Оболочка модального окна: оверлей, панель по центру экрана и переходы
открытия и закрытия. Заголовок, текст и кнопки кладёт в слот приложение. На
этой оболочке построен `ConfirmationModal`.
